...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["I Quit, This Game Sucks!",	"Beat Isaac's Week on Hard with no Misses.",		'isaacWeek_nomiss',		false],
		["Wow, You Suck!",				"Complete a Song with a rating lower than 20%.",	'ur_bad',				false],
