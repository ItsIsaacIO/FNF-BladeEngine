...
class Note extends FlxSprite
{
	...
	public var playerNote:Bool = true;
	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?noteSkin:String = 'BoyfriendNotes', ?playerNote:Bool = true)
	{
		super();
	...
	function loadNoteAnims() {
		animation.addByPrefix('greenScroll', 'UpArrow');
		animation.addByPrefix('redScroll', 'RightArrow');
		animation.addByPrefix('blueScroll', 'DownArrow');
		animation.addByPrefix('purpleScroll', 'LeftArrow');
