...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BladeEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BladeEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "6";
		app.meta["company"] = "ItsIsaacIO";
		app.meta["file"] = "BladeEngine";
		app.meta["name"] = "FNF - Blade Engine";
		app.meta["packageName"] = "om.itsisaacio.bladeengine";
