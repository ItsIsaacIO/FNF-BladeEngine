...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_sharpen_full_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_sharpen_inst_ogg extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_sharpen_midi_mid extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_songs_sharpen_voices_ogg extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_backgrounds_stageback_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_shared_images_songnamebar_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
