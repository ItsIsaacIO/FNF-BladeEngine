...
HX_DEFINE_STACK_FRAME(_hx_pos_69524c8888607e26_84_new,"Rating","new",0xe6bfabaf,"Rating.new","Conductor.hx",84,0xeb0fa157)
HX_LOCAL_STACK_FRAME(_hx_pos_69524c8888607e26_108_increase,"Rating","increase",0x83e50213,"Rating.increase","Conductor.hx",108,0xeb0fa157)

void Rating_obj::__construct(::String name){
            	HX_STACKFRAME(&_hx_pos_69524c8888607e26_84_new)
HXLINE(  92)		this->noteSplash = true;
HXLINE(  91)		this->score = 350;
HXLINE(  90)		this->ratingMod = ((Float)1);
HXLINE(  89)		this->hitWindow = 0;
HXLINE(  88)		this->counter = HX_("",00,00,00,00);
HXLINE(  87)		this->image = HX_("",00,00,00,00);
HXLINE(  86)		this->name = HX_("",00,00,00,00);
HXLINE(  96)		this->name = name;
HXLINE(  97)		this->image = name;
HXLINE(  98)		this->counter = (name + HX_("s",73,00,00,00));
HXLINE(  99)		this->hitWindow = ::Reflect_obj::field(::hx::ClassOf< ::ClientPrefs >(),(name + HX_("Window",10,08,21,87)));
HXLINE( 100)		if (::hx::IsNull( this->hitWindow )) {
HXLINE( 102)			this->hitWindow = 0;
            		}
            	}
...
void Rating_obj::increase(::hx::Null< int >  __o_blah){
            	...
            	HX_STACKFRAME(&_hx_pos_69524c8888607e26_108_increase)
HXDLIN( 108)		 ::PlayState _hx_tmp = ::PlayState_obj::instance;
HXDLIN( 108)		::String _hx_tmp1 = this->counter;
HXDLIN( 108)		::Reflect_obj::setField(_hx_tmp,_hx_tmp1,(::Reflect_obj::field(::PlayState_obj::instance,this->counter) + blah));
            	}
