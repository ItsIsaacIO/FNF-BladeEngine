...
HXLINE(  87)		 ::flixel::FlxSprite _hx_tmp4 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
...
HXDLIN(  87)		this->magenta = _hx_tmp4->loadGraphic(returnAsset1,null(),null(),null(),null(),null());
HXLINE(  88)		this->magenta->scrollFactor->set(0,yScroll);
HXLINE(  89)		 ::flixel::FlxSprite _hx_tmp5 = this->magenta;
HXDLIN(  89)		_hx_tmp5->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.175))),null());
HXLINE(  90)		this->magenta->updateHitbox();
HXLINE(  91)		{
HXLINE(  91)			 ::flixel::FlxSprite _this = this->magenta;
HXDLIN(  91)			 ::flixel::util::FlxAxes axes1 = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(  91)			bool _hx_tmp6;
HXDLIN(  91)			switch((int)(axes1->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXDLIN(  91)				_this->set_x(((( (Float)(_hx_tmp) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  91)			bool _hx_tmp7;
HXDLIN(  91)			switch((int)(axes1->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE(  91)					_hx_tmp7 = true;
            				}
            				break;
            				default:{
HXLINE(  91)					_hx_tmp7 = false;
            				}
            			}
HXDLIN(  91)			if (_hx_tmp7) {
HXLINE(  91)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(  91)				_this->set_y(((( (Float)(_hx_tmp) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  92)		this->magenta->set_visible(false);
HXLINE(  93)		this->magenta->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  94)		this->magenta->set_color(-12288);
...
HXDLIN( 118)						menuItem->set_x(((( (Float)(_hx_tmp) ) - menuItem->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN( 118)						menuItem->set_y(((( (Float)(_hx_tmp) ) - menuItem->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE( 130)		 ::flixel::text::FlxText versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,12,(::flixel::FlxG_obj::height - 24),0,((HX_("Blade Engine (",12,5f,86,4f) + ::MainMenuState_obj::engineVersion) + HX_(")",29,00,00,00)),12,null());
...
HXLINE( 146)		bool _hx_tmp8;
HXDLIN( 146)		if ((leDate->getDay() == 5)) {
HXLINE( 146)			_hx_tmp8 = (leDate->getHours() >= 18);
            		}
            		else {
...
HXLINE( 267)			 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 267)			if (::hx::IsNull( axes )) {
HXLINE( 267)				axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            			}
HXDLIN( 267)			bool _hx_tmp;
HXDLIN( 267)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
...
HXDLIN( 267)				spr->set_x(((( (Float)(_hx_tmp) ) - spr->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN( 267)				spr->set_y(((( (Float)(_hx_tmp) ) - spr->get_height()) / ( (Float)(2) )));
            			}
            		}
...
::String MainMenuState_obj::engineVersion;
...
static ::hx::StaticInfo MainMenuState_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &MainMenuState_obj::engineVersion,HX_("engineVersion",76,23,20,fc)},
...
static void MainMenuState_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(MainMenuState_obj::engineVersion,"engineVersion");
...
static void MainMenuState_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(MainMenuState_obj::engineVersion,"engineVersion");
...
HXDLIN(  28)		engineVersion = HX_("0.1.0",75,ff,c8,c1);
            	}
{
