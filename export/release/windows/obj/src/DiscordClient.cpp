...
HXLINE(  19)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("997913261859147798",d5,d5,5d,20))
...
HXDLIN(  44)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("Main Menu",e6,3a,4e,c8))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("icon",79,e7,b2,45))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Blade Engine",8a,8c,62,88))));
            	}
...
HXLINE(  85)		::String _hx_tmp = (HX_("Engine Version: ",e0,15,79,71) + ::MainMenuState_obj::engineVersion);
