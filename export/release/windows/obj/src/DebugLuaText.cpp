...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2633_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",2633,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_2645_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",2645,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2633_new)
HXLINE(2635)		this->disableTime = ((Float)6);
HXLINE(2638)		this->parentGroup = parentGroup;
HXLINE(2639)		super::__construct(10,10,0,text,16,null());
HXLINE(2640)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN(2640)		::String _hx_tmp;
HXDLIN(2640)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE(2640)			_hx_tmp = file;
            		}
            		else {
HXLINE(2640)			_hx_tmp = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN(2640)		this->setFormat(_hx_tmp,20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(2641)		this->scrollFactor->set(null(),null());
HXLINE(2642)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_2645_update)
HXLINE(2646)		this->super::update(elapsed);
HXLINE(2647)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2647)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(2648)		if ((this->disableTime <= 0)) {
HXLINE(2649)			this->kill();
HXLINE(2650)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(2651)			this->destroy();
            		}
            		else {
HXLINE(2653)			if ((this->disableTime < 1)) {
HXLINE(2653)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
