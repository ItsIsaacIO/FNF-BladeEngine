...
static const ::String _hx_array_data_0afa74a2_2[] = {
	HX_("UpArrow",4e,c1,55,4f),HX_("RightArrow",6d,64,05,1f),HX_("DownArrow",e7,2d,78,dd),HX_("LeftArrow",22,48,42,dc),
};
...
HXDLIN(  72)				 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(HX_("noteSkins/Boyfriend",3f,1a,cb,53),null());
HXDLIN(  72)				bool xmlExists = false;
HXDLIN(  72)				if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("noteSkins/Boyfriend",3f,1a,cb,53)) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE(  72)					 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("noteSkins/Boyfriend",3f,1a,cb,53),library);
HXDLIN(  72)					_hx_tmp = returnAsset;
            				}
HXDLIN(  72)				::String _hx_tmp1;
HXDLIN(  72)				if (xmlExists) {
HXLINE(  72)					_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("noteSkins/Boyfriend",3f,1a,cb,53)) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE(  72)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("noteSkins/Boyfriend",3f,1a,cb,53)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            				}
