...
HXLINE(  26)		this->warnText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,((((HX_("Hey! Looks like you're using   \n\n\t\t\tan old version of Blade Engine (",b1,87,fe,0d) + ::MainMenuState_obj::engineVersion) + HX_("),\n\n\t\t\tupdate to ",d4,34,99,d0)) + ::TitleState_obj::updateVersion) + HX_(" if you want.\n\n\t\t\tPress ESCAPE to proceed anyway.\n\n\t\t\t\n\n\t\t\tThanks for using Blade Engine!",74,29,7e,3f)),32,null());
...
HXLINE(  44)				::CoolUtil_obj::browserLoad(HX_("https://github.com/ItsIsaacIO/FNF-BladeEngine/releases",3e,37,25,d2));
            			}
            			else {
