...
HX_LOCAL_STACK_FRAME(_hx_pos_3744063e02200643_29_update,"PhillyGlowParticle","update",0x06096cbc,"PhillyGlowParticle.update","PhillyGlow.hx",29,0x72857fe9)
...
HXLINE(  20)		this->originalScale = ::flixel::FlxG_obj::random->_hx_float(((Float)0.75),1,null());
HXLINE(  21)		this->scale->set(this->originalScale,this->originalScale);
HXLINE(  23)		 ::flixel::math::FlxPoint _hx_tmp = this->scrollFactor;
HXDLIN(  23)		Float _hx_tmp1 = ::flixel::FlxG_obj::random->_hx_float(((Float)0.3),((Float)0.75),null());
HXDLIN(  23)		_hx_tmp->set(_hx_tmp1,::flixel::FlxG_obj::random->_hx_float(((Float)0.65),((Float)0.75),null()));
HXLINE(  24)		 ::flixel::math::FlxPoint _hx_tmp2 = this->velocity;
HXDLIN(  24)		Float _hx_tmp3 = ::flixel::FlxG_obj::random->_hx_float(-40,40,null());
HXDLIN(  24)		_hx_tmp2->set(_hx_tmp3,::flixel::FlxG_obj::random->_hx_float(-175,-250,null()));
HXLINE(  25)		 ::flixel::math::FlxPoint _hx_tmp4 = this->acceleration;
HXDLIN(  25)		_hx_tmp4->set(::flixel::FlxG_obj::random->_hx_float(-10,10,null()),25);
            	}
...
void PhillyGlowParticle_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3744063e02200643_29_update)
HXLINE(  30)		 ::PhillyGlowParticle _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  30)		_hx_tmp->lifeTime = (_hx_tmp->lifeTime - elapsed);
HXLINE(  31)		if ((this->lifeTime < 0)) {
HXLINE(  33)			this->lifeTime = ( (Float)(0) );
HXLINE(  34)			this->set_alpha((this->alpha - (this->decay * elapsed)));
HXLINE(  35)			if ((this->alpha > 0)) {
HXLINE(  37)				this->scale->set((this->originalScale * this->alpha),(this->originalScale * this->alpha));
            			}
            		}
