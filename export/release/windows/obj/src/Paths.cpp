...
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_462_pushGlobalMods,"Paths","pushGlobalMods",0xd773a24e,"Paths.pushGlobalMods","Paths.hx",462,0x309ea470)
HX_LOCAL_STACK_FRAME(_hx_pos_d75e02b628d1544a_492_getModDirectories,"Paths","getModDirectories",0x27c7a23f,"Paths.getModDirectories","Paths.hx",492,0x309ea470)
...
HXLINE( 223)		::String songKey = ((HX_("",00,00,00,00) + ::StringTools_obj::replace(song.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00))) + HX_("/Voices",10,18,4f,34));
...
HXLINE( 230)		::String songKey = ((HX_("",00,00,00,00) + ::StringTools_obj::replace(song.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00))) + HX_("/Inst",95,b3,69,40));
...
HXDLIN( 327)		return ::StringTools_obj::replace(path.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
            	}
...
::Array< ::String > Paths_obj::pushGlobalMods(){
            	HX_GC_STACKFRAME(&_hx_pos_d75e02b628d1544a_462_pushGlobalMods)
HXLINE( 463)		::Paths_obj::globalMods = ::Array_obj< ::String >::__new(0);
HXLINE( 464)		if (::sys::FileSystem_obj::exists(HX_("modsList.txt",f1,ca,08,ac))) {
HXLINE( 466)			::Array< ::String > list = ::CoolUtil_obj::listFromString(::sys::io::File_obj::getContent(HX_("modsList.txt",f1,ca,08,ac)));
HXLINE( 467)			{
HXLINE( 467)				int _g = 0;
HXDLIN( 467)				while((_g < list->length)){
HXLINE( 467)					::String i = list->__get(_g);
HXDLIN( 467)					_g = (_g + 1);
HXLINE( 469)					::Array< ::String > dat = i.split(HX_("|",7c,00,00,00));
HXLINE( 470)					if ((dat->__get(1) == HX_("1",31,00,00,00))) {
HXLINE( 472)						::String folder = dat->__get(0);
HXLINE( 473)						::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 473)						if (::hx::IsNull( key )) {
HXLINE( 473)							key = HX_("",00,00,00,00);
            						}
HXDLIN( 473)						::String path = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 474)						if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 475)							try {
            								HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 476)								::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 477)								bool _hx_tmp;
HXDLIN( 477)								if (::hx::IsNotNull( rawJson )) {
HXLINE( 477)									_hx_tmp = (rawJson.length > 0);
            								}
            								else {
HXLINE( 477)									_hx_tmp = false;
            								}
HXDLIN( 477)								if (_hx_tmp) {
HXLINE( 478)									 ::Dynamic stuff =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 479)									bool global = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("runsGlobally",98,2d,b5,06))) );
HXLINE( 480)									if (global) {
HXLINE( 480)										::Paths_obj::globalMods->push(dat->__get(0));
            									}
            								}
            							} catch( ::Dynamic _hx_e) {
...
HXDLIN( 482)									 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
HXLINE( 483)									::haxe::Log_obj::trace(e,::hx::SourceInfo(HX_("source/Paths.hx",64,c7,bd,1c),483,HX_("Paths",0e,7b,84,50),HX_("pushGlobalMods",ee,c8,dc,25)));
            								}
            								else {
...
HXLINE( 489)		return ::Paths_obj::globalMods;
            	}
...
::Array< ::String > Paths_obj::getModDirectories(){
            	HX_STACKFRAME(&_hx_pos_d75e02b628d1544a_492_getModDirectories)
HXLINE( 493)		::Array< ::String > list = ::Array_obj< ::String >::__new(0);
HXLINE( 494)		::String modsFolder = HX_("mods/",9e,2f,58,0c);
HXLINE( 495)		if (::sys::FileSystem_obj::exists(modsFolder)) {
HXLINE( 496)			int _g = 0;
HXDLIN( 496)			::Array< ::String > _g1 = ::sys::FileSystem_obj::readDirectory(modsFolder);
HXDLIN( 496)			while((_g < _g1->length)){
HXLINE( 496)				::String folder = _g1->__get(_g);
HXDLIN( 496)				_g = (_g + 1);
HXLINE( 497)				::String path = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,modsFolder)->init(1,folder));
HXLINE( 498)				bool _hx_tmp;
HXDLIN( 498)				bool _hx_tmp1;
HXDLIN( 498)				if (::sys::FileSystem_obj::isDirectory(path)) {
HXLINE( 498)					_hx_tmp1 = !(::Paths_obj::ignoreModFolders->contains(folder));
            				}
            				else {
HXLINE( 498)					_hx_tmp1 = false;
            				}
HXDLIN( 498)				if (_hx_tmp1) {
HXLINE( 498)					_hx_tmp = !(list->contains(folder));
            				}
            				else {
HXLINE( 498)					_hx_tmp = false;
            				}
HXDLIN( 498)				if (_hx_tmp) {
HXLINE( 499)					list->push(folder);
            				}
            			}
            		}
HXLINE( 503)		return list;
            	}
