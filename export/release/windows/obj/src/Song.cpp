...
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_51_onLoadJson,"Song","onLoadJson",0xe02d2786,"Song.onLoadJson","Song.hx",51,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_91_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",91,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_140_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",140,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_34_new)
HXLINE(  48)		this->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  47)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  46)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  43)		this->speed = ((Float)1);
HXLINE(  40)		this->needsVoices = true;
HXLINE(  85)		this->song = song;
HXLINE(  86)		this->notes = notes;
HXLINE(  87)		this->bpm = bpm;
            	}
...
void Song_obj::onLoadJson( ::Dynamic songJson){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_51_onLoadJson)
HXLINE(  52)		if (::hx::IsNull( songJson->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic) )) {
HXLINE(  54)			songJson->__SetField(HX_("gfVersion",b9,c6,7d,f3),songJson->__Field(HX_("player3",b2,09,15,8a),::hx::paccDynamic),::hx::paccDynamic);
HXLINE(  55)			songJson->__SetField(HX_("player3",b2,09,15,8a),null(),::hx::paccDynamic);
            		}
HXLINE(  58)		if (::hx::IsNull( songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic) )) {
HXLINE(  60)			songJson->__SetField(HX_("events",19,4f,6a,96),::cpp::VirtualArray_obj::__new(0),::hx::paccDynamic);
HXLINE(  61)			{
HXLINE(  61)				int _g = 0;
HXDLIN(  61)				int _g1 = ( (int)( ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
HXDLIN(  61)				while((_g < _g1)){
HXLINE(  61)					_g = (_g + 1);
HXDLIN(  61)					int secNum = (_g - 1);
HXLINE(  63)					 ::Dynamic sec =  ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(secNum);
HXLINE(  65)					int i = 0;
HXLINE(  66)					::cpp::VirtualArray notes = ( (::cpp::VirtualArray)(sec->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXLINE(  67)					int len = notes->get_length();
HXLINE(  68)					while((i < len)){
HXLINE(  70)						::cpp::VirtualArray note = ( (::cpp::VirtualArray)(notes->__get(i)) );
HXLINE(  71)						if (::hx::IsLess( note->__get(1),0 )) {
HXLINE(  73)							 ::Dynamic(songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic))->__Field(HX_("push",da,11,61,4a),::hx::paccDynamic)(::Array_obj< ::Dynamic>::__new(2)->init(0,note->__get(0))->init(1,::Array_obj< ::Dynamic>::__new(1)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,note->__get(2))->init(1,note->__get(3))->init(2,note->__get(4)))));
HXLINE(  74)							notes->remove(note);
HXLINE(  75)							len = notes->get_length();
            						}
            						else {
HXLINE(  77)							i = (i + 1);
            						}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_91_loadFromJson)
HXLINE(  92)		::String rawJson = null();
HXLINE(  94)		::String formattedFolder = ::StringTools_obj::replace(folder.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE(  95)		::String formattedSong = ::StringTools_obj::replace(jsonInput.toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE(  97)		::String moddyFile = ::Paths_obj::modFolders(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
HXLINE(  98)		if (::sys::FileSystem_obj::exists(moddyFile)) {
HXLINE(  99)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(moddyFile));
            		}
HXLINE( 103)		if (::hx::IsNull( rawJson )) {
HXLINE( 105)			::String library = null();
HXDLIN( 105)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
            		}
HXLINE( 111)		while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE( 113)			rawJson = rawJson.substr(0,(rawJson.length - 1));
            		}
HXLINE( 133)		 ::Dynamic songJson = ::Song_obj::parseJSONshit(rawJson);
HXLINE( 134)		if ((jsonInput != HX_("events",19,4f,6a,96))) {
HXLINE( 134)			::StageData_obj::loadDirectory(songJson);
            		}
HXLINE( 135)		::Song_obj::onLoadJson(songJson);
HXLINE( 136)		return songJson;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_140_parseJSONshit)
HXLINE( 141)		 ::Dynamic swagShit =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
HXLINE( 142)		swagShit->__SetField(HX_("validScore",b6,dc,18,c7),true,::hx::paccDynamic);
HXLINE( 143)		return swagShit;
            	}
