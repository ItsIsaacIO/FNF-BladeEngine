...
HX_DEFINE_STACK_FRAME(_hx_pos_d9d5d3b163e280bc_44_new,"PhillyGlowGradient","new",0xe0392477,"PhillyGlowGradient.new","PhillyGlow.hx",44,0x72857fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_d9d5d3b163e280bc_61_update,"PhillyGlowGradient","update",0x79609a52,"PhillyGlowGradient.update","PhillyGlow.hx",61,0x72857fe9)
HX_LOCAL_STACK_FRAME(_hx_pos_d9d5d3b163e280bc_80_bop,"PhillyGlowGradient","bop",0xe030121a,"PhillyGlowGradient.bop","PhillyGlow.hx",80,0x72857fe9)

void PhillyGlowGradient_obj::__construct(Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_d9d5d3b163e280bc_44_new)
HXLINE(  47)		this->originalHeight = 400;
HXLINE(  50)		super::__construct(x,y,null());
HXLINE(  51)		this->originalY = y;
HXLINE(  53)		::String library = null();
HXDLIN(  53)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("philly/gradient",f7,e4,ce,c2),library);
HXDLIN(  53)		this->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  54)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  55)		this->scrollFactor->set(0,((Float)0.75));
HXLINE(  56)		this->setGraphicSize(2000,this->originalHeight);
...
void PhillyGlowGradient_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_d9d5d3b163e280bc_61_update)
HXLINE(  62)		int newHeight = ::Math_obj::round((this->get_height() - (( (Float)(1000) ) * elapsed)));
HXLINE(  63)		if ((newHeight > 0)) {
HXLINE(  65)			this->set_alpha(( (Float)(1) ));
HXLINE(  66)			this->setGraphicSize(2000,newHeight);
HXLINE(  67)			this->updateHitbox();
HXLINE(  68)			Float _hx_tmp = this->originalY;
HXDLIN(  68)			int _hx_tmp1 = this->originalHeight;
HXDLIN(  68)			this->set_y((_hx_tmp + (( (Float)(_hx_tmp1) ) - this->get_height())));
            		}
            		else {
HXLINE(  72)			this->set_alpha(( (Float)(0) ));
HXLINE(  73)			this->set_y(( (Float)(-5000) ));
            		}
...
void PhillyGlowGradient_obj::bop(){
            	HX_STACKFRAME(&_hx_pos_d9d5d3b163e280bc_80_bop)
HXLINE(  81)		this->setGraphicSize(2000,this->originalHeight);
HXLINE(  82)		this->updateHitbox();
HXLINE(  83)		this->set_y(this->originalY);
HXLINE(  84)		this->set_alpha(( (Float)(1) ));
            	}
