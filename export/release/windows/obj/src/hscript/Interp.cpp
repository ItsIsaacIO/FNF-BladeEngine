...
HXLINE( 259)			return this->expr(e);
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE( 260)				 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 440)							r = me->exprReturn(fexpr);
            							...
            							if (_hx_e.IsClass<  ::Dynamic >() ){
            								HX_STACK_BEGIN_CATCH
            								 ::Dynamic _g = _hx_e;
HXLINE( 441)								 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 536)					return v;
            					...
            					if (_hx_e.IsClass<  ::Dynamic >() ){
            						HX_STACK_BEGIN_CATCH
            						 ::Dynamic _g = _hx_e;
HXLINE( 537)						 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 587)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 588)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 604)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 605)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
...
HXLINE( 633)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::Dynamic >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::Dynamic _g = _hx_e;
HXLINE( 634)					 ::Dynamic _g1 = ::haxe::Exception_obj::caught(_g)->unwrap();
