...
::shaders::CromaticShader_obj::__register();
::settings::BGSettings_obj::__register();
...
::editors::StageEditorState_obj::__register();
...
::settings::BGSettings_obj::__boot();
::shaders::CromaticShader_obj::__boot();
