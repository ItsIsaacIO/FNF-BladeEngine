...
HXDLIN(  13)		achievementsStuff = ::cpp::VirtualArray_obj::__new(7)->init(0,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("Freaky on a Friday Night",ad,12,d0,d9))->init(1,HX_("Play on a Friday... Night.",1b,3d,4b,6e))->init(2,HX_("friday_night_play",9b,1f,4e,c7))->init(3,true))->init(1,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("I Quit, This Game Sucks!",7e,53,b9,8a))->init(1,HX_("Beat Isaac's Week on Hard with no Misses.",44,86,0c,43))->init(2,HX_("isaacWeek_nomiss",8f,82,48,a4))->init(3,false))->init(2,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("Wow, You Suck!",03,88,4e,2e))->init(1,HX_("Complete a Song with a rating lower than 20%.",b8,88,a7,a1))->init(2,HX_("ur_bad",a3,4f,85,aa))->init(3,false))->init(3,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("Perfectionist",2f,2d,d8,1a))->init(1,HX_("Complete a Song with a rating of 100%.",60,20,3e,99))->init(2,HX_("ur_good",9f,19,79,8d))->init(3,false))->init(4,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("Oversinging Much...?",7f,24,1b,aa))->init(1,HX_("Hold down a note for 10 seconds.",47,92,e2,c6))->init(2,HX_("oversinging",1f,13,8f,78))->init(3,false))->init(5,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("Hyperactive",12,ed,1a,97))->init(1,HX_("Finish a Song without going Idle.",3d,4e,8d,8b))->init(2,HX_("hype",46,63,1a,45))->init(3,false))->init(6,::cpp::VirtualArray_obj::__new(4)->init(0,HX_("Toaster Gamer",b4,2b,0d,33))->init(1,HX_("Have you tried to run the game on a toaster?",97,b9,bf,ff))->init(2,HX_("toastie",43,0c,91,5f))->init(3,false));
            	}
{
