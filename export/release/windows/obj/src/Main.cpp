...
HXLINE(  78)		::Main_obj::fpsVar =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  79)		this->addChild(::Main_obj::fpsVar);
HXLINE(  80)		::openfl::Lib_obj::get_current()->stage->align = ::openfl::display::_StageAlign::StageAlign_Impl__obj::fromString(HX_("tl",78,65,00,00));
HXLINE(  81)		::openfl::Lib_obj::get_current()->stage->set_scaleMode(2);
HXLINE(  82)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE(  83)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
