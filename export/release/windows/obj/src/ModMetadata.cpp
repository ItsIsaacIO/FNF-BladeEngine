...
HX_DEFINE_STACK_FRAME(_hx_pos_f8fd466029c4d025_727_new,"ModMetadata","new",0x98e8f1a3,"ModMetadata.new","ModsMenuState.hx",727,0xc380473d)

void ModMetadata_obj::__construct(::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_f8fd466029c4d025_727_new)
HXLINE( 728)		this->folder = folder;
HXLINE( 729)		this->name = folder;
HXLINE( 730)		this->description = HX_("No description provided.",88,46,cb,66);
HXLINE( 731)		this->color = ::ModsMenuState_obj::defaultColor;
HXLINE( 732)		this->restart = false;
HXLINE( 735)		::String key = (folder + HX_("/pack.json",ce,a9,3a,e3));
HXDLIN( 735)		if (::hx::IsNull( key )) {
HXLINE( 735)			key = HX_("",00,00,00,00);
            		}
HXDLIN( 735)		::String path = (HX_("mods/",9e,2f,58,0c) + key);
HXLINE( 736)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 737)			::String rawJson = ::sys::io::File_obj::getContent(path);
HXLINE( 738)			bool _hx_tmp;
HXDLIN( 738)			if (::hx::IsNotNull( rawJson )) {
HXLINE( 738)				_hx_tmp = (rawJson.length > 0);
            			}
            			else {
HXLINE( 738)				_hx_tmp = false;
            			}
HXDLIN( 738)			if (_hx_tmp) {
HXLINE( 739)				 ::Dynamic stuff =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse();
HXLINE( 741)				::Array< int > colors = ( (::Array< int >)(::Reflect_obj::getProperty(stuff,HX_("color",63,71,5c,4a))) );
HXLINE( 742)				::String description = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("description",fc,08,1d,5f))) );
HXLINE( 743)				::String name = ( (::String)(::Reflect_obj::getProperty(stuff,HX_("name",4b,72,ff,48))) );
HXLINE( 744)				bool restart = ( (bool)(::Reflect_obj::getProperty(stuff,HX_("restart",cf,c7,a5,6a))) );
HXLINE( 746)				bool _hx_tmp;
HXDLIN( 746)				if (::hx::IsNotNull( name )) {
HXLINE( 746)					_hx_tmp = (name.length > 0);
            				}
            				else {
HXLINE( 746)					_hx_tmp = false;
            				}
HXDLIN( 746)				if (_hx_tmp) {
HXLINE( 748)					this->name = name;
            				}
HXLINE( 750)				bool _hx_tmp1;
HXDLIN( 750)				if (::hx::IsNotNull( description )) {
HXLINE( 750)					_hx_tmp1 = (description.length > 0);
            				}
            				else {
HXLINE( 750)					_hx_tmp1 = false;
            				}
HXDLIN( 750)				if (_hx_tmp1) {
HXLINE( 752)					this->description = description;
            				}
HXLINE( 754)				bool _hx_tmp2;
HXDLIN( 754)				if (::hx::IsNotNull( colors )) {
HXLINE( 754)					_hx_tmp2 = (colors->length > 2);
            				}
            				else {
HXLINE( 754)					_hx_tmp2 = false;
            				}
HXDLIN( 754)				if (_hx_tmp2) {
HXLINE( 756)					int Red = colors->__get(0);
HXDLIN( 756)					int Green = colors->__get(1);
HXDLIN( 756)					int Blue = colors->__get(2);
HXDLIN( 756)					int Alpha = 255;
HXDLIN( 756)					int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 756)					{
HXLINE( 756)						color = (color & -16711681);
HXDLIN( 756)						int color1;
HXDLIN( 756)						if ((Red > 255)) {
HXLINE( 756)							color1 = 255;
            						}
            						else {
HXLINE( 756)							if ((Red < 0)) {
HXLINE( 756)								color1 = 0;
...
HXLINE( 756)								color1 = Red;
            							}
            						}
HXDLIN( 756)						color = (color | (color1 << 16));
            					}
HXDLIN( 756)					{
HXLINE( 756)						color = (color & -65281);
HXDLIN( 756)						int color2;
HXDLIN( 756)						if ((Green > 255)) {
HXLINE( 756)							color2 = 255;
            						}
            						else {
HXLINE( 756)							if ((Green < 0)) {
HXLINE( 756)								color2 = 0;
            							}
            							else {
HXLINE( 756)								color2 = Green;
            							}
            						}
HXDLIN( 756)						color = (color | (color2 << 8));
            					}
HXDLIN( 756)					{
HXLINE( 756)						color = (color & -256);
HXDLIN( 756)						int color3;
HXDLIN( 756)						if ((Blue > 255)) {
HXLINE( 756)							color3 = 255;
            						}
            						else {
HXLINE( 756)							if ((Blue < 0)) {
HXLINE( 756)								color3 = 0;
            							}
            							else {
HXLINE( 756)								color3 = Blue;
            							}
            						}
HXDLIN( 756)						color = (color | color3);
            					}
HXDLIN( 756)					{
HXLINE( 756)						color = (color & 16777215);
HXDLIN( 756)						int color4;
HXDLIN( 756)						if ((Alpha > 255)) {
HXLINE( 756)							color4 = 255;
            						}
            						else {
HXLINE( 756)							if ((Alpha < 0)) {
HXLINE( 756)								color4 = 0;
            							}
            							else {
HXLINE( 756)								color4 = Alpha;
            							}
            						}
HXDLIN( 756)						color = (color | (color4 << 24));
            					}
HXDLIN( 756)					this->color = color;
            				}
HXLINE( 759)				this->restart = restart;
            			}
            		}
            	}
