...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("BladeEngine",5a,2c,00,37),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("ItsIsaacIO",d7,b8,39,0d));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("BladeEngine",5a,2c,00,37));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("FNF - Blade Engine",3f,68,26,7d));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("om.itsisaacio.bladeengine",93,f7,89,de));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("FNF - Blade Engine",3f,68,26,7d))
