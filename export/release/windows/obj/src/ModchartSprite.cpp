...
HX_DEFINE_STACK_FRAME(_hx_pos_2b7f7cc83b4d0792_2608_new,"ModchartSprite","new",0xbc67fd93,"ModchartSprite.new","FunkinLua.hx",2608,0x00117937)
...
void ModchartSprite_obj::__construct( ::Dynamic __o_x, ::Dynamic __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_2b7f7cc83b4d0792_2608_new)
HXLINE(2610)		this->wasAdded = false;
HXLINE(2615)		super::__construct(x,y,null());
HXLINE(2616)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
