...
#define INCLUDED_editors_StageEditorState
...
HX_DECLARE_CLASS1(editors,StageEditorState)
...
class HXCPP_CLASS_ATTRIBUTES StageEditorState_obj : public  ::MusicBeatState_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x59ed76cc };

		void __construct(::String __o_daAnim,::hx::Null< bool >  __o_goToPlayState);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="editors.StageEditorState")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"editors.StageEditorState"); }
		static ::hx::ObjectPtr< StageEditorState_obj > __new(::String __o_daAnim,::hx::Null< bool >  __o_goToPlayState);
		static ::hx::ObjectPtr< StageEditorState_obj > __alloc(::hx::Ctx *_hx_ctx,::String __o_daAnim,::hx::Null< bool >  __o_goToPlayState);
		...
		::Dynamic addSettingsUI_dyn();
		 ...
		 ::flixel::addons::ui::FlxUICheckBox camFollowNotesBox;
...
#endif /* INCLUDED_editors_StageEditorState */ 
