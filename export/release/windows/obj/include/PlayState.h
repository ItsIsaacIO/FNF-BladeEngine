...
class HXCPP_CLASS_ATTRIBUTES PlayState_obj : public  ::MusicBeatState_obj
{
	...
	public:
		...
		static ::Dynamic cancelMusicFadeTween_dyn();
		 ...
		 ::haxe::ds::StringMap modchartObjects;
		...
		bool doneDodging;
		 ::flixel::_hx_system::FlxSound attackNotifier;
		...
		void countdownAfterStart();
		::Dynamic countdownAfterStart_dyn();
		...
		void generateStaticArrows(int player, ::Dynamic alpha);
		::Dynamic generateStaticArrows_dyn();

		void editStaticArrows(int player,Float newAlpha,Float alphaTweenTime,::Array< int > notesToEdit);
		::Dynamic editStaticArrows_dyn();
